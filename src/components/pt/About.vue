    ...
    <div id="brief-desc">
      ...
      <form method="post" @submit="sendEmail">
        <div class="form-container">
          ...
          <input style="width: 30em; padding: 10px; border-radius: 5px; border: none; margin-bottom: 10px;" id="contact" name="email" v-model="email" type="email" placeholder="exemplo@org.com.br"/>
